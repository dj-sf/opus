americasOtherArmy = Book.create(:name => "America's Other Army", :year_published => 2012)
...
nationsStatesAndViolence = Book.create(:name => "Nations, States, and Violence", :year_published => 2007)
...
containingNationalism = Book.create(:name => "Containing Nationalism", :year_published => 2007)
